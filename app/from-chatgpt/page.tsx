    ...
    <main className="min-h-screen bg-paper text-ink">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-5">
          <Link href={`${base}/`} className="text-xl font-black">EDUWILLS</Link>
          <Link href={`${base}/signup/`} className="rounded-xl bg-eduBlue px-4 py-2.5 text-sm font-black text-white">Start learning</Link>
        </div>
      </header>
      ...
      <section className="mx-auto max-w-5xl px-5 pb-16 pt-16 sm:pt-24">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href={`${base}/signup/`} className="rounded-xl bg-eduBlue px-6 py-3.5 font-black text-white">Create your account</Link>
          <Link href={`${base}/study-guides/`} className="rounded-xl border border-slate-300 bg-white px-6 py-3.5 font-black">Study guides</Link>
        </div>
        ...
        <section className="mt-10 rounded-[2rem] bg-ink p-7 text-white sm:p-9">
          <h2 className="text-2xl font-black">Start with the material you already study.</h2>
          <p className="mt-3 max-w-2xl leading-7 text-slate-300">Choose a book or topic, practise what you know, review what you missed and keep improving.</p>
          <Link href={`${base}/signup/`} className="mt-6 inline-flex rounded-xl bg-white px-5 py-3 font-black text-ink">Try EDUWILLS →</Link>
        </section>
      </section>
