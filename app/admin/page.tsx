...
const BASE = '/eduwills';
const durations = [
  ['30 minutes', 30 * 60 * 1000], ['1 hour', 60 * 60 * 1000], ['6 hours', 6 * 60 * 60 * 1000], ['12 hours', 12 * 60 * 60 * 1000],
  ['1 day', 24 * 60 * 60 * 1000], ['7 days', 7 * 24 * 60 * 60 * 1000], ['14 days', 14 * 24 * 60 * 60 * 1000], ['30 days', 30 * 24 * 60 * 60 * 1000],
