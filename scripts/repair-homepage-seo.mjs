...
// Make the primary homepage heading and supporting copy search-relevant while keeping the existing design.
page=page.replace(
  'Turn every book into a <span className="text-eduBlue">smart quiz.</span>',
  'AI quiz generator for <span className="text-eduBlue">WAEC, JAMB & NECO.</span> Turn every book into a smart quiz.'
);
page=page.replace(
...
console.log('EDUWILLS homepage SEO content and keyword-focused hero applied.');
