...
// users collection. Replace the complete effect, including its dependency list,
// in one operation so the generated TSX cannot acquire an extra closing brace.
