...
// Keep this repair script deliberately simple: all inserted source is plain strings.
// This avoids nested template literals/JSX escaping breaking node --check.
...
// Premium question/options styling. Only replace stable class strings; no JSX is generated here.
...
console.log('Quiz exam security/UI v2 applied: warning on leaving the test, automatic submission after a second leave, and premium question/options styling.');
